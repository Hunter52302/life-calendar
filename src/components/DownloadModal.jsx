...
import { openExternal, isTauri } from '../lib/utils';
        ...
        {release === false && !loading && (
          <div className="p-8 flex flex-col items-center gap-3 text-center">
            ...
            <a
              ...
              onClick={e => { if (isTauri()) { e.preventDefault(); openExternal(GITHUB_RELEASES_PAGE); } }}
              target="_blank"
        ...
        {hasRelease && (
          <div className="p-6 space-y-3">
            {PLATFORMS.map(p => {
              ...
              const unavailable = !p.comingSoon && !url && !altUrl;
                  ...
                  {(url || altUrl) && (
                    <div className="flex flex-wrap gap-2">
                      {url && (
                        <a
                          href={url}
                          onClick={e => { if (isTauri()) { e.preventDefault(); openExternal(url); } }}
                      ...
                      {altUrl && (
                        <a
                          href={altUrl}
                          onClick={e => { if (isTauri()) { e.preventDefault(); openExternal(altUrl); } }}
